        ...
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center px-8 sm:w-2/3 gap-4">
                ...
                <div className="flex w-full gap-4 flex-col pb-8">
                    ...
                    <Image src="/images/old-sky.png" width={800} height={400} className="border-8 border-purple-400 rounded-lg"/>
                    ...
                    <Image src="/images/sky-home.png" width={800} height={400} className="border-8 border-purple-400 rounded-lg"/>
                    ...
                    <Image src="/images/sky-backend.png" width={800} height={400} className="border-8 border-purple-400 rounded-lg"/>
                </div>
            </div>
        </div>
    )
